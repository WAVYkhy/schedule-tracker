...
export const translations = {
  ko: {
    ...
    service_basic: '커버곡/오리지널곡 (14일 소요)',
    service_live2d: '커버곡/오리지널곡 + Live2D (21일 소요)',
  ...
  ja: {
    ...
    service_basic: 'カバー曲/オリジナル曲 (14日所要)',
    service_live2d: 'カバー曲/オリジナル曲 + Live2D (21日所要)',
  ...
  en: {
    ...
    service_basic: 'Cover / Original Song (14 days needed)',
    service_live2d: 'Cover / Original Song + Live2D (21 days needed)',
